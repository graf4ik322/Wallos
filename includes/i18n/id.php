...
$i18n = [
    ...
    "lifetime_purchases" => "Pembelian seumur hidup",
    "daily" => "Hari",
    "weekly" => "Minggu",
    "monthly" => "Bulan",
    "yearly" => "Tahun",
    ...
    "require_email_verified_linking" => "Wajibkan email terverifikasi untuk menautkan akun",
    "oidc_email_not_verified" => "Login gagal: alamat email Anda belum diverifikasi oleh penyedia identitas.",
    ...
    "auth_tagline" => "Ketahui ke mana uang Anda pergi.",
    "auth_tagline_sub" => "Pantau langganan Anda, lihat pengeluaran Anda, dan jangan pernah lewatkan perpanjangan.",
    "overview" => "Ringkasan",
    "trends_and_forecast" => "Tren & Perkiraan",
    "history_and_lifetime" => "Riwayat & Total",
    "cost_per_day" => "Biaya per Hari",
    "median_monthly_cost" => "Median Biaya Langganan Bulanan",
    "cheapest_subscription" => "Langganan Termurah",
    "vs_last_month" => "vs Bulan Lalu",
    "heaviest_month" => "Bulan Mendatang Termahal",
    "months_over_budget" => "Bulan Melebihi Anggaran (12 Berikutnya)",
    "manual_renewals" => "Perpanjangan Manual",
    "all_time_spend" => "Total Pengeluaran (perkiraan)",
    "oldest_subscription" => "Langganan Terlama (Tahun)",
    "average_subscription_age" => "Rata-rata Usia Langganan (Tahun)",
    "projected_cost" => "Proyeksi Biaya (12 Bulan ke Depan)",
    "lifetime_spend" => "Pengeluaran Seumur Hidup (10 Teratas, perkiraan)",
    "billing_cycle_split" => "Pembagian Siklus Penagihan",
    "currency_split" => "Pembagian Mata Uang",
    "price_distribution" => "Distribusi Harga",
    "subscriptions_count" => "Langganan",
    "new_subscriptions_per_year" => "Langganan Baru per Tahun",
    "estimated_from_current_prices" => "Diperkirakan dari harga saat ini",
    "translate_categories" => "Terjemahkan dengan AI",
    "week_starts_on_sunday" => "Mulai minggu pada hari Minggu di kalender",
