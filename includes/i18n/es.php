...
$i18n = [
    ...
    "restore_database_info" => "Se requiere un token de configuración para restaurar una copia de seguridad. Obténgalo usando uno de los métodos a continuación:",
    "setup_token_docker" => "Docker: ejecute docker logs &lt;container-name&gt; y busque \"Setup token for database restore\"",
    "setup_token_file" => "Bare metal: lea el archivo db/setup_token.db en el servidor",
    ...
    "Yearly" => "Anual",
    "One-time" => "Único",
    "lifetime_purchases" => "Compras de por vida",
    "daily" => "Día(s)",
    "weekly" => "Semana(s)",
    "monthly" => "Mes(es)",
    "yearly" => "Año(s)",
    ...
    "require_email_verified_linking" => "Requerir correo electrónico verificado para vincular cuenta",
    "oidc_email_not_verified" => "Error de inicio de sesión: su dirección de correo electrónico no ha sido verificada por el proveedor de identidad.",
    ...
    "auth_tagline" => "Sepa a dónde va su dinero.",
    "auth_tagline_sub" => "Controle sus suscripciones, consulte sus gastos y no se pierda ninguna renovación.",
    "overview" => "Resumen",
    "trends_and_forecast" => "Tendencias y previsión",
    "history_and_lifetime" => "Historial y total",
    "cost_per_day" => "Coste por día",
    "median_monthly_cost" => "Mediana del coste mensual de suscripción",
    "cheapest_subscription" => "Suscripción más barata",
    "vs_last_month" => "vs mes anterior",
    "heaviest_month" => "Próximo mes más caro",
    "months_over_budget" => "Meses por encima del presupuesto (próximos 12)",
    "manual_renewals" => "Renovaciones manuales",
    "all_time_spend" => "Gasto total (est.)",
    "oldest_subscription" => "Suscripción más antigua (años)",
    "average_subscription_age" => "Antigüedad media de las suscripciones (años)",
    "projected_cost" => "Coste proyectado (próximos 12 meses)",
    "lifetime_spend" => "Gasto acumulado (Top 10, est.)",
    "billing_cycle_split" => "Distribución por ciclo de facturación",
    "currency_split" => "Distribución por moneda",
    "price_distribution" => "Distribución de precios",
    "subscriptions_count" => "Suscripciones",
    "new_subscriptions_per_year" => "Nuevas suscripciones por año",
    "estimated_from_current_prices" => "Estimado según los precios actuales",
    "translate_categories" => "Traducir con IA",
    "week_starts_on_sunday" => "Comenzar la semana en domingo en el calendario",
    "list_view" => "Vista de lista",
    "grid_view" => "Vista de cuadrícula",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "¿Aún no tiene una cuenta?",
    "already_have_account" => "¿Ya tiene una cuenta?",
    "google_search_info" => "Añade resultados de imágenes de Google (a través de SerpAPI) como fuente adicional en la búsqueda de logotipos. Cree una cuenta gratuita de SerpAPI y pegue aquí su clave API.",
    "monthly_searches_used" => "Búsquedas utilizadas este mes",
    "monthly_requests_used" => "Solicitudes de API utilizadas este mes",
