...
$i18n = [
    ...
    "lifetime_purchases" => "Zakupy dożywotnie",
    "daily" => "Dzień/Dni",
    ...
    "registrations_disable_login_info" => "Po włączeniu rejestracji użytkowników opcja wyłączenia logowania będzie niedostępna.",
    ...
    "require_email_verified_linking" => "Wymagaj zweryfikowanego e-maila do łączenia kont",
    "oidc_email_not_verified" => "Logowanie nie powiodło się: adres e-mail nie został zweryfikowany przez dostawcę tożsamości.",
    ...
    "auth_tagline" => "Wiedz, na co idą twoje pieniądze.",
    "auth_tagline_sub" => "Śledź swoje subskrypcje, kontroluj wydatki i nie przegap żadnego odnowienia.",
    "overview" => "Przegląd",
    "trends_and_forecast" => "Trendy i prognoza",
    "history_and_lifetime" => "Historia i suma",
    "cost_per_day" => "Koszt dzienny",
    "median_monthly_cost" => "Mediana miesięcznego kosztu subskrypcji",
    "cheapest_subscription" => "Najtańsza subskrypcja",
    "vs_last_month" => "względem poprzedniego miesiąca",
    "heaviest_month" => "Najdroższy nadchodzący miesiąc",
    "months_over_budget" => "Miesiące powyżej budżetu (następne 12)",
    "manual_renewals" => "Ręczne odnowienia",
    "all_time_spend" => "Łączne wydatki (szac.)",
    "oldest_subscription" => "Najstarsza subskrypcja (lata)",
    "average_subscription_age" => "Średni wiek subskrypcji (lata)",
    "projected_cost" => "Prognozowany koszt (następne 12 miesięcy)",
    "lifetime_spend" => "Łączne wydatki (Top 10, szac.)",
    "billing_cycle_split" => "Podział według cyklu rozliczeniowego",
    "currency_split" => "Podział według waluty",
    "price_distribution" => "Rozkład cen",
    "subscriptions_count" => "Subskrypcje",
    "new_subscriptions_per_year" => "Nowe subskrypcje rocznie",
    "estimated_from_current_prices" => "Oszacowano na podstawie aktualnych cen",
    "translate_categories" => "Przetłumacz z AI",
    "week_starts_on_sunday" => "Rozpoczynaj tydzień w niedzielę w kalendarzu",
    "list_view" => "Widok listy",
    "grid_view" => "Widok siatki",
    "oidc_oauth_enabled" => "Włącz OIDC/OAuth",
