...
$i18n = [
    ...
    "Yearly" => "Letno",
    "One-time" => "Enkratno",
    "lifetime_purchases" => "Doživljenjski nakupi",
    "daily" => "Dan (dni)",
    "weekly" => "Teden (tednov)",
    ...
    "registrations_disable_login_info" => "Če omogočite registracijo uporabnikov, nastavitev za onemogočanje prijave ne bo na voljo.",
    ...
    "require_email_verified_linking" => "Zahtevaj preverjen e-naslov za povezovanje računa",
    "oidc_email_not_verified" => "Prijava ni uspela: vaš e-poštni naslov ni bil preverjen s strani ponudnika identitete.",
    ...
    "auth_tagline" => "Vedite, kam gre vaš denar.",
    "auth_tagline_sub" => "Spremljajte svoje naročnine, preglejte porabo in nikoli ne zamudite podaljšanja.",
    "overview" => "Pregled",
    "trends_and_forecast" => "Trendi in napoved",
    "history_and_lifetime" => "Zgodovina in skupno",
    "cost_per_day" => "Strošek na dan",
    "median_monthly_cost" => "Mediana mesečnih stroškov naročnin",
    "cheapest_subscription" => "Najcenejša naročnina",
    "vs_last_month" => "glede na prejšnji mesec",
    "heaviest_month" => "Najdražji prihajajoči mesec",
    "months_over_budget" => "Meseci nad proračunom (naslednjih 12)",
    "manual_renewals" => "Ročna podaljšanja",
    "all_time_spend" => "Skupna poraba (ocena)",
    "oldest_subscription" => "Najstarejša naročnina (leta)",
    "average_subscription_age" => "Povprečna starost naročnin (leta)",
    "projected_cost" => "Predvideni stroški (naslednjih 12 mesecev)",
    "lifetime_spend" => "Skupna poraba (Top 10, ocena)",
    "billing_cycle_split" => "Razdelitev po obračunskem ciklu",
    "currency_split" => "Razdelitev po valuti",
    "price_distribution" => "Porazdelitev cen",
    "subscriptions_count" => "Naročnine",
    "new_subscriptions_per_year" => "Nove naročnine na leto",
    "estimated_from_current_prices" => "Ocenjeno na podlagi trenutnih cen",
    "translate_categories" => "Prevedi z AI",
    "week_starts_on_sunday" => "Začni teden z nedeljo v koledarju",
    "list_view" => "Pogled seznama",
    "grid_view" => "Mrežni pogled",
    "account" => "Račun",
    "export_subscriptions" => "Izvozi naročnine",
    "export_as_json" => "Izvozi kot JSON",
    "export_as_csv" => "Izvozi kot CSV",
    "danger_zone" => "Nevarno območje",
    "delete_account" => "Izbriši račun",
    "delete_account_info" => "Z izbrisom računa boste izbrisali tudi vse svoje naročnine in nastavitve.",
    "oidc_oauth_enabled" => "Omogoči OIDC/OAuth",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "Še nimate računa?",
    "already_have_account" => "Že imate račun?",
    "google_search_info" => "Doda rezultate slik Google (prek SerpAPI) kot dodaten vir pri iskanju logotipov. Ustvarite brezplačen račun SerpAPI in sem prilepite svoj ključ API.",
    "monthly_searches_used" => "Porabljena iskanja ta mesec",
    "monthly_requests_used" => "Porabljene zahteve API ta mesec",
