...
$i18n = [
    ...
    "oidc_email_not_verified" => "Falha no início de sessão: o seu endereço de e-mail não foi verificado pelo fornecedor de identidade.",
    ...
    "auth_tagline_sub" => "Acompanhe as suas subscrições, veja os seus gastos e nunca perca uma renovação.",
    "overview" => "Visão geral",
    "trends_and_forecast" => "Tendências e previsão",
    "history_and_lifetime" => "Histórico e total",
    "cost_per_day" => "Custo por dia",
    "median_monthly_cost" => "Mediana do custo mensal das subscrições",
    "cheapest_subscription" => "Subscrição mais barata",
    ...
    "oldest_subscription" => "Subscrição mais antiga (anos)",
    "average_subscription_age" => "Idade média das subscrições (anos)",
    "projected_cost" => "Custo projetado (próximos 12 meses)",
    "lifetime_spend" => "Gasto acumulado (Top 10, est.)",
    "billing_cycle_split" => "Distribuição por ciclo de faturação",
    "currency_split" => "Distribuição por moeda",
    "price_distribution" => "Distribuição de preços",
    "subscriptions_count" => "Subscrições",
    "new_subscriptions_per_year" => "Novas subscrições por ano",
    "estimated_from_current_prices" => "Estimado com base nos preços atuais",
    "translate_categories" => "Traduzir com IA",
    "week_starts_on_sunday" => "Começar a semana ao domingo no calendário",
    ...
    "google_search_info" => "Adiciona resultados de imagens do Google (via SerpAPI) como fonte adicional na pesquisa de logótipos. Crie uma conta gratuita na SerpAPI e cole aqui a sua chave API.",
    "monthly_searches_used" => "Pesquisas utilizadas este mês",
    "monthly_requests_used" => "Pedidos de API utilizados este mês",
