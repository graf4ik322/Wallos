...
$i18n = [
    ...
    "lifetime_purchases" => "Ömür boyu satın almalar",
    "daily" => "Gün(ler)",
    "weekly" => "Hafta(lar)",
    "monthly" => "Ay(lar)",
    "yearly" => "Yıl(lar)",
    ...
    "require_email_verified_linking" => "Hesap bağlamak için doğrulanmış e-posta gerekli",
    "oidc_email_not_verified" => "Giriş başarısız: e-posta adresiniz kimlik sağlayıcı tarafından doğrulanmamış.",
    ...
    "auth_tagline" => "Paranızın nereye gittiğini bilin.",
    "auth_tagline_sub" => "Aboneliklerinizi takip edin, harcamalarınızı görün ve hiçbir yenilemeyi kaçırmayın.",
    "overview" => "Genel Bakış",
    "trends_and_forecast" => "Eğilimler ve Tahmin",
    "history_and_lifetime" => "Geçmiş ve Toplam",
    "cost_per_day" => "Günlük Maliyet",
    "median_monthly_cost" => "Aylık Abonelik Maliyeti Medyanı",
    "cheapest_subscription" => "En Ucuz Abonelik",
    "vs_last_month" => "geçen aya göre",
    "heaviest_month" => "En Pahalı Yaklaşan Ay",
    "months_over_budget" => "Bütçeyi Aşan Aylar (Sonraki 12)",
    "manual_renewals" => "Manuel Yenilemeler",
    "all_time_spend" => "Toplam Harcama (tahmini)",
    "oldest_subscription" => "En Eski Abonelik (Yıl)",
    "average_subscription_age" => "Ortalama Abonelik Yaşı (Yıl)",
    "projected_cost" => "Öngörülen Maliyet (Sonraki 12 Ay)",
    "lifetime_spend" => "Toplam Harcama (İlk 10, tahmini)",
    "billing_cycle_split" => "Fatura Döngüsüne Göre Dağılım",
    "currency_split" => "Para Birimine Göre Dağılım",
    "price_distribution" => "Fiyat Dağılımı",
    "subscriptions_count" => "Abonelikler",
    "new_subscriptions_per_year" => "Yılda Yeni Abonelik",
    "estimated_from_current_prices" => "Mevcut fiyatlara göre tahmin edilmiştir",
    "translate_categories" => "Yapay zekâ ile çevir",
    "week_starts_on_sunday" => "Takvimde haftayı pazar günü başlat",
    "list_view" => "Liste görünümü",
    "grid_view" => "Izgara görünümü",
    "oidc_oauth_enabled" => "OIDC/OAuth'u etkinleştir",
