...
$i18n = [
    ...
    "Yearly" => "Årligt",
    "One-time" => "Engangskøb",
    "lifetime_purchases" => "Livstidskøb",
    "daily" => "Dag(e)",
    "weekly" => "Uge(r)",
    "monthly" => "Måned(er)",
    "yearly" => "År",
    ...
    "registrations_disable_login_info" => "Ved at aktivere brugerregistrering vil indstillingen for at deaktivere login ikke være tilgængelig.",
    ...
    "require_email_verified_linking" => "Kræv verificeret e-mail til kontotilknytning",
    "oidc_email_not_verified" => "Login mislykkedes: din e-mailadresse er ikke verificeret af identitetsudbyderen.",
    ...
    "auth_tagline" => "Vid, hvor dine penge går hen.",
    "auth_tagline_sub" => "Hold styr på dine abonnementer, se dit forbrug, og gå aldrig glip af en fornyelse.",
    "overview" => "Overblik",
    "trends_and_forecast" => "Tendenser og prognose",
    "history_and_lifetime" => "Historik og samlet",
    "cost_per_day" => "Omkostning pr. dag",
    "median_monthly_cost" => "Median månedlig abonnementsudgift",
    "cheapest_subscription" => "Billigste abonnement",
    "vs_last_month" => "ift. sidste måned",
    "heaviest_month" => "Dyreste kommende måned",
    "months_over_budget" => "Måneder over budget (næste 12)",
    "manual_renewals" => "Manuelle fornyelser",
    "all_time_spend" => "Samlet forbrug (est.)",
    "oldest_subscription" => "Ældste abonnement (år)",
    "average_subscription_age" => "Gennemsnitlig abonnementsalder (år)",
    "projected_cost" => "Forventet udgift (næste 12 måneder)",
    "lifetime_spend" => "Samlet forbrug (top 10, est.)",
    "billing_cycle_split" => "Fordeling efter betalingscyklus",
    "currency_split" => "Fordeling efter valuta",
    "price_distribution" => "Prisfordeling",
    "subscriptions_count" => "Abonnementer",
    "new_subscriptions_per_year" => "Nye abonnementer pr. år",
    "estimated_from_current_prices" => "Estimeret ud fra aktuelle priser",
    "translate_categories" => "Oversæt med AI",
    "week_starts_on_sunday" => "Start ugen med søndag i kalenderen",
