...
$i18n = [
    ...
    "Yearly" => "Annuel",
    "One-time" => "Unique",
    "lifetime_purchases" => "Achats à vie",
    "daily" => "Jour(s)",
    "weekly" => "Semaine(s)",
    "monthly" => "Mois",
    "yearly" => "Année(s)",
    ...
    "registrations_disable_login_info" => "En activant les inscriptions des utilisateurs, le paramètre permettant de désactiver la connexion ne sera plus disponible.",
    ...
    "require_email_verified_linking" => "Exiger un e-mail vérifié pour la liaison de compte",
    "oidc_email_not_verified" => "Échec de la connexion : votre adresse e-mail n'a pas été vérifiée par le fournisseur d'identité.",
    ...
    "auth_tagline" => "Sachez où va votre argent.",
    "auth_tagline_sub" => "Suivez vos abonnements, visualisez vos dépenses et ne manquez aucun renouvellement.",
    "overview" => "Vue d'ensemble",
    "trends_and_forecast" => "Tendances et prévisions",
    "history_and_lifetime" => "Historique et cumul",
    "cost_per_day" => "Coût par jour",
    "median_monthly_cost" => "Coût mensuel médian des abonnements",
    "cheapest_subscription" => "Abonnement le moins cher",
    "vs_last_month" => "vs le mois dernier",
    "heaviest_month" => "Mois à venir le plus coûteux",
    "months_over_budget" => "Mois au-dessus du budget (12 prochains)",
    "manual_renewals" => "Renouvellements manuels",
    "all_time_spend" => "Dépenses totales (est.)",
    "oldest_subscription" => "Abonnement le plus ancien (années)",
    "average_subscription_age" => "Âge moyen des abonnements (années)",
    "projected_cost" => "Coût projeté (12 prochains mois)",
    "lifetime_spend" => "Dépenses cumulées (Top 10, est.)",
    "billing_cycle_split" => "Répartition par cycle de facturation",
    "currency_split" => "Répartition par devise",
    "price_distribution" => "Répartition des prix",
    "subscriptions_count" => "Abonnements",
    "new_subscriptions_per_year" => "Nouveaux abonnements par an",
    "estimated_from_current_prices" => "Estimé à partir des prix actuels",
    "translate_categories" => "Traduire avec l'IA",
    "week_starts_on_sunday" => "Commencer la semaine le dimanche dans le calendrier",
    "list_view" => "Vue liste",
    "grid_view" => "Vue grille",
    "oidc_oauth_enabled" => "Activer OIDC/OAuth",
