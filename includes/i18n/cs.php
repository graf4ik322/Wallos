...
$i18n = [
    ...
    "lifetime_purchases" => "Doživotní nákupy",
    "daily" => "dní",
    "weekly" => "týdnů",
    "monthly" => "měsíců",
    "yearly" => "roků",
    ...
    "registrations_disable_login_info" => "Povolením registrace uživatelů nebude nastavení pro zakázání přihlášení k dispozici.",
    ...
    "require_email_verified_linking" => "Vyžadovat ověřený e-mail pro propojení účtu",
    "oidc_email_not_verified" => "Přihlášení selhalo: e-mailová adresa nebyla ověřena poskytovatelem identity.",
    ...
    "auth_tagline" => "Vězte, kam jdou vaše peníze.",
    "auth_tagline_sub" => "Sledujte svá předplatná, mějte přehled o výdajích a nezmeškejte žádné obnovení.",
    "overview" => "Přehled",
    "trends_and_forecast" => "Trendy a předpověď",
    "history_and_lifetime" => "Historie a celkem",
    "cost_per_day" => "Náklady na den",
    "median_monthly_cost" => "Medián měsíčních nákladů na předplatné",
    "cheapest_subscription" => "Nejlevnější předplatné",
    "vs_last_month" => "oproti minulému měsíci",
    "heaviest_month" => "Nejnákladnější nadcházející měsíc",
    "months_over_budget" => "Měsíce nad rozpočet (příštích 12)",
    "manual_renewals" => "Ruční obnovení",
    "all_time_spend" => "Celkové výdaje (odhad)",
    "oldest_subscription" => "Nejstarší předplatné (roky)",
    "average_subscription_age" => "Průměrné stáří předplatných (roky)",
    "projected_cost" => "Předpokládané náklady (příštích 12 měsíců)",
    "lifetime_spend" => "Celkové výdaje (Top 10, odhad)",
    "billing_cycle_split" => "Rozdělení podle fakturačního cyklu",
    "currency_split" => "Rozdělení podle měny",
    "price_distribution" => "Rozložení cen",
    "subscriptions_count" => "Předplatná",
    "new_subscriptions_per_year" => "Nová předplatná za rok",
    "estimated_from_current_prices" => "Odhad podle aktuálních cen",
    "translate_categories" => "Přeložit pomocí AI",
    "week_starts_on_sunday" => "Začínat týden v kalendáři nedělí",
