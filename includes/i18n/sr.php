...
$i18n = [
    ...
    "Monthly" => "Месечно",
    "Yearly" => "Годишње",
    "One-time" => "Једнократно",
    "lifetime_purchases" => "Доживотне куповине",
    "daily" => "дана",
    "weekly" => "недеља",
    "monthly" => "месеци",
    "yearly" => "година",
    "one-time" => "Једнократно",
    "payment_date" => "Датум плаћања",
    "days" => "дана",
    "weeks" => "недеља",
    "months" => "месеци",
    "years" => "године",
    ...
    "remove_background_info" => "Ово такође прави другу, прекројену верзију логотипа, како би остао читљив приликом преласка између светле и тамне теме.",
    ...
    "registrations_disable_login_info" => "Омогућавањем регистрације корисника, подешавање за онемогућавање пријаве неће бити доступно.",
    ...
    "require_email_verified_linking" => "Захтевај верификовану е-пошту за повезивање налога",
    "oidc_email_not_verified" => "Пријава неуспешна: е-маил адреса није верификована од стране провајдера идентитета.",
    ...
    "auth_tagline" => "Знајте где иде ваш новац.",
    "auth_tagline_sub" => "Пратите своје претплате, погледајте трошкове и никада не пропустите обнову.",
    "overview" => "Преглед",
    "trends_and_forecast" => "Трендови и прогноза",
    "history_and_lifetime" => "Историја и укупно",
    "cost_per_day" => "Трошак по дану",
    "median_monthly_cost" => "Медијана месечних трошкова претплата",
    "cheapest_subscription" => "Најјефтинија претплата",
    "vs_last_month" => "у односу на прошли месец",
    "heaviest_month" => "Најскупљи предстојећи месец",
    "months_over_budget" => "Месеци преко буџета (наредних 12)",
    "manual_renewals" => "Ручне обнове",
    "all_time_spend" => "Укупна потрошња (процена)",
    "oldest_subscription" => "Најстарија претплата (године)",
    "average_subscription_age" => "Просечна старост претплата (године)",
    "projected_cost" => "Пројектовани трошак (наредних 12 месеци)",
    "lifetime_spend" => "Укупна потрошња (Топ 10, процена)",
    "billing_cycle_split" => "Подела по циклусу наплате",
    "currency_split" => "Подела по валути",
    "price_distribution" => "Расподела цена",
    "subscriptions_count" => "Претплате",
    "new_subscriptions_per_year" => "Нове претплате годишње",
    "estimated_from_current_prices" => "Процењено на основу тренутних цена",
    "translate_categories" => "Преведи помоћу AI",
    "week_starts_on_sunday" => "Почни седмицу недељом у календару",
    "list_view" => "Приказ листе",
    "grid_view" => "Приказ мреже",
    "oidc_oauth_enabled" => "Омогући OIDC/OAuth",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "Још немате налог?",
