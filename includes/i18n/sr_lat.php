...
$i18n = [
    ...
    "lifetime_purchases" => "Doživotne kupovine",
    "daily" => "dana",
    "weekly" => "nedelja",
    "monthly" => "meseci",
    "yearly" => "godina",
    ...
    "remove_background_info" => "Ovo takođe pravi drugu, prekrojenu verziju logotipa, kako bi ostao čitljiv prilikom prelaska između svetle i tamne teme.",
    ...
    "require_email_verified_linking" => "Zahtevaj verifikovanu e-poštu za povezivanje naloga",
    "oidc_email_not_verified" => "Prijava neuspešna: e-mail adresa nije verifikovana od strane provajdera identiteta.",
    ...
    "auth_tagline" => "Znajte gde ide vaš novac.",
    "auth_tagline_sub" => "Pratite svoje pretplate, pogledajte troškove i nikada ne propustite obnovu.",
    "overview" => "Pregled",
    "trends_and_forecast" => "Trendovi i prognoza",
    "history_and_lifetime" => "Istorija i ukupno",
    "cost_per_day" => "Trošak po danu",
    "median_monthly_cost" => "Medijana mesečnih troškova pretplata",
    "cheapest_subscription" => "Najjeftinija pretplata",
    "vs_last_month" => "u odnosu na prošli mesec",
    "heaviest_month" => "Najskuplji predstojeći mesec",
    "months_over_budget" => "Meseci preko budžeta (narednih 12)",
    "manual_renewals" => "Ručne obnove",
    "all_time_spend" => "Ukupna potrošnja (procena)",
    "oldest_subscription" => "Najstarija pretplata (godine)",
    "average_subscription_age" => "Prosečna starost pretplata (godine)",
    "projected_cost" => "Projektovani trošak (narednih 12 meseci)",
    "lifetime_spend" => "Ukupna potrošnja (Top 10, procena)",
    "billing_cycle_split" => "Podela po ciklusu naplate",
    "currency_split" => "Podela po valuti",
    "price_distribution" => "Raspodela cena",
    "subscriptions_count" => "Pretplate",
    "new_subscriptions_per_year" => "Nove pretplate godišnje",
    "estimated_from_current_prices" => "Procenjeno na osnovu trenutnih cena",
    "translate_categories" => "Prevedi pomoću AI",
    "week_starts_on_sunday" => "Počni sedmicu nedeljom u kalendaru",
    "list_view" => "Prikaz liste",
    "grid_view" => "Prikaz mreže",
    "oidc_oauth_enabled" => "Omogući OIDC/OAuth",
