...
$i18n = [
    ...
    "restore_database_info" => "Este necesar un token de configurare pentru a restaura o copie de rezervă. Recuperați-l folosind una dintre metodele de mai jos:",
    "setup_token_docker" => "Docker: rulați docker logs &lt;container-name&gt; și căutați \"Setup token for database restore\"",
    "setup_token_file" => "Bare metal: citiți fișierul db/setup_token.db de pe server",
    "select_backup_file" => "Selectați fișierul de rezervă",
    // Login Page
    ...
    "lifetime_purchases" => "Achiziții pe viață",
    "daily" => "Zile",
    "weekly" => "Săptămâni",
    "monthly" => "Luni",
    "yearly" => "Ani",
    ...
    "registrations_disable_login_info" => "Prin activarea înregistrării utilizatorilor, opțiunea de dezactivare a autentificării nu va fi disponibilă.",
    ...
    "require_email_verified_linking" => "Necesită e-mail verificat pentru conectarea contului",
    "oidc_email_not_verified" => "Autentificare eșuată: adresa de e-mail nu a fost verificată de furnizorul de identitate.",
    ...
    "auth_tagline" => "Aflați unde se duc banii dumneavoastră.",
    "auth_tagline_sub" => "Urmăriți-vă abonamentele, vedeți cheltuielile și nu ratați nicio reînnoire.",
    "overview" => "Prezentare generală",
    "trends_and_forecast" => "Tendințe și prognoză",
    "history_and_lifetime" => "Istoric și total",
    "cost_per_day" => "Cost pe zi",
    "median_monthly_cost" => "Costul lunar median al abonamentelor",
    "cheapest_subscription" => "Cel mai ieftin abonament",
    "vs_last_month" => "față de luna trecută",
    "heaviest_month" => "Cea mai scumpă lună viitoare",
    "months_over_budget" => "Luni peste buget (următoarele 12)",
    "manual_renewals" => "Reînnoiri manuale",
    "all_time_spend" => "Cheltuieli totale (est.)",
    "oldest_subscription" => "Cel mai vechi abonament (ani)",
    "average_subscription_age" => "Vârsta medie a abonamentelor (ani)",
    "projected_cost" => "Cost estimat (următoarele 12 luni)",
    "lifetime_spend" => "Cheltuieli cumulate (Top 10, est.)",
    "billing_cycle_split" => "Repartizare după ciclul de facturare",
    "currency_split" => "Repartizare după monedă",
    "price_distribution" => "Distribuția prețurilor",
    "subscriptions_count" => "Abonamente",
    "new_subscriptions_per_year" => "Abonamente noi pe an",
    "estimated_from_current_prices" => "Estimat pe baza prețurilor actuale",
    "translate_categories" => "Traduceți cu AI",
    "week_starts_on_sunday" => "Începeți săptămâna duminica în calendar",
    "list_view" => "Vizualizare listă",
    "grid_view" => "Vizualizare grilă",
    "no_account_yet" => "Nu aveți încă un cont?",
