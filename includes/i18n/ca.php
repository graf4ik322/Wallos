...
$i18n = [
    ...
    "Yearly" => "Anual",
    "One-time" => "Únic",
    "lifetime_purchases" => "Compres de per vida",
    "daily" => "Dia / Dies",
    ...
    "two_factor_info" => "L'autenticació de dos factors afegeix una capa addicional de seguretat al teu compte, <br>  Necessitaràs una aplicació d’autenticació com Google Authenticator, Authy o Ente Auth per escanejar el codi QR.",
    ...
    "registrations_disable_login_info" => "Al activar el registre d'usuaris, l'opció per desactivar l'inici de sessió no estarà disponible.",
    ...
    "require_email_verified_linking" => "Requerir correu electrònic verificat per vincular el compte",
    "oidc_email_not_verified" => "Error d'inici de sessió: la vostra adreça de correu electrònic no ha estat verificada pel proveïdor d'identitat.",
    ...
    "auth_tagline" => "Sàpigues on van els teus diners.",
    "auth_tagline_sub" => "Controla les teves subscripcions, consulta les teves despeses i no et perdis cap renovació.",
    "overview" => "Resum",
    "trends_and_forecast" => "Tendències i previsió",
    "history_and_lifetime" => "Historial i total",
    "cost_per_day" => "Cost per dia",
    "median_monthly_cost" => "Mediana del cost mensual de subscripció",
    "cheapest_subscription" => "Subscripció més barata",
    "vs_last_month" => "vs el mes passat",
    "heaviest_month" => "Mes vinent més car",
    "months_over_budget" => "Mesos per sobre del pressupost (propers 12)",
    "manual_renewals" => "Renovacions manuals",
    "all_time_spend" => "Despesa total (est.)",
    "oldest_subscription" => "Subscripció més antiga (anys)",
    "average_subscription_age" => "Antiguitat mitjana de les subscripcions (anys)",
    "projected_cost" => "Cost projectat (propers 12 mesos)",
    "lifetime_spend" => "Despesa acumulada (Top 10, est.)",
    "billing_cycle_split" => "Distribució per cicle de facturació",
    "currency_split" => "Distribució per moneda",
    "price_distribution" => "Distribució de preus",
    "subscriptions_count" => "Subscripcions",
    "new_subscriptions_per_year" => "Subscripcions noves per any",
    "estimated_from_current_prices" => "Estimat a partir dels preus actuals",
    "translate_categories" => "Tradueix amb IA",
    "week_starts_on_sunday" => "Comença la setmana en diumenge al calendari",
    "list_view" => "Vista de llista",
    "grid_view" => "Vista de graella",
    "no_account_yet" => "Encara no tens un compte?",
