...
$i18n = [
    ...
    "setup_token" => 'Token di configurazione',
    "restore_database_info" => 'È necessario un token di configurazione per ripristinare un backup. Recuperalo usando uno dei metodi seguenti:',
    "setup_token_docker" => 'Docker: esegui docker logs &lt;container-name&gt; e cerca "Setup token for database restore"',
    "setup_token_file" => 'Bare metal: leggi il file db/setup_token.db sul server',
    ...
    "Yearly" => 'Annuale',
    "One-time" => "Una tantum",
    "lifetime_purchases" => "Acquisti a vita",
    "daily" => 'Giorno/i',
    "weekly" => 'Settimana/e',
    "monthly" => 'Mese/i',
    "yearly" => 'Anno/i',
    ...
    "registrations_disable_login_info" => "Abilitando le registrazioni degli utenti, l'impostazione per disabilitare il login non sarà disponibile.",
    ...
    "require_email_verified_linking" => "Richiedi email verificata per il collegamento dell'account",
    "oidc_email_not_verified" => "Accesso fallito: il tuo indirizzo email non è stato verificato dal provider di identità.",
    ...
    "auth_tagline" => "Scopri dove vanno i tuoi soldi.",
    "auth_tagline_sub" => "Tieni traccia dei tuoi abbonamenti, controlla le tue spese e non perdere mai un rinnovo.",
    "overview" => "Panoramica",
    "trends_and_forecast" => "Tendenze e previsioni",
    "history_and_lifetime" => "Cronologia e totale",
    "cost_per_day" => "Costo al giorno",
    "median_monthly_cost" => "Costo mensile mediano degli abbonamenti",
    "cheapest_subscription" => "Abbonamento più economico",
    "vs_last_month" => "vs mese scorso",
    "heaviest_month" => "Prossimo mese più costoso",
    "months_over_budget" => "Mesi oltre il budget (prossimi 12)",
    "manual_renewals" => "Rinnovi manuali",
    "all_time_spend" => "Spesa totale (stima)",
    "oldest_subscription" => "Abbonamento più vecchio (anni)",
    "average_subscription_age" => "Età media degli abbonamenti (anni)",
    "projected_cost" => "Costo previsto (prossimi 12 mesi)",
    "lifetime_spend" => "Spesa complessiva (Top 10, stima)",
    "billing_cycle_split" => "Ripartizione per ciclo di fatturazione",
    "currency_split" => "Ripartizione per valuta",
    "price_distribution" => "Distribuzione dei prezzi",
    "subscriptions_count" => "Abbonamenti",
    "new_subscriptions_per_year" => "Nuovi abbonamenti all'anno",
    "estimated_from_current_prices" => "Stima basata sui prezzi attuali",
    "translate_categories" => "Traduci con IA",
    "week_starts_on_sunday" => "Inizia la settimana di domenica nel calendario",
    "list_view" => "Vista elenco",
    "grid_view" => "Vista griglia",
    "reminder" => "Promemoria",
    "cancellation" => "Cancellazione",
    "send_to_other_emails" => "Invia le notifiche anche ai seguenti indirizzi email (usa ; per separarli):",
    "oidc_oauth_enabled" => "Abilita OIDC/OAuth",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "Non hai ancora un account?",
    "already_have_account" => "Hai già un account?",
    "google_search_info" => "Aggiunge i risultati immagini di Google (tramite SerpAPI) come fonte aggiuntiva nella ricerca dei loghi. Crea un account SerpAPI gratuito e incolla qui la tua chiave API.",
    "monthly_searches_used" => "Ricerche utilizzate questo mese",
    "monthly_requests_used" => "Richieste API utilizzate questo mese",
