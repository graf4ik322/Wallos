...
$i18n = [
    ...
    "setup_token" => "Токен налаштування",
    "restore_database_info" => "Для відновлення резервної копії потрібен токен налаштування. Отримайте його одним із способів нижче:",
    "setup_token_docker" => "Docker: виконайте docker logs &lt;container-name&gt; і знайдіть \"Setup token for database restore\"",
    "setup_token_file" => "Bare metal: прочитайте файл db/setup_token.db на сервері",
    "select_backup_file" => "Вибрати файл резервної копії",
    // Login Page
    ...
    "lifetime_purchases" => "Безстрокові покупки",
    "daily" => "День",
    "weekly" => "Тиждень",
    "monthly" => "Місяць",
    "yearly" => "Рік",
    ...
    "remove_background_info" => "Це також створює другу, перефарбовану версію логотипу, щоб він залишався читабельним під час перемикання між світлою та темною темами.",
    ...
    "registrations_disable_login_info" => "Якщо увімкнути реєстрацію користувачів, налаштування вимкнення входу стане недоступним.",
    ...
    "require_email_verified_linking" => "Вимагати підтвердженого e-mail для прив'язки облікового запису",
    "oidc_email_not_verified" => "Помилка входу: електронну адресу не підтверджено постачальником ідентифікаційних даних.",
    ...
    "auth_tagline" => "Знайте, куди йдуть ваші гроші.",
    "auth_tagline_sub" => "Відстежуйте підписки, переглядайте витрати й ніколи не пропускайте поновлення.",
    "overview" => "Огляд",
    "trends_and_forecast" => "Тренди та прогноз",
    "history_and_lifetime" => "Історія та підсумки",
    "cost_per_day" => "Вартість на день",
    "median_monthly_cost" => "Медіанна місячна вартість підписки",
    "cheapest_subscription" => "Найдешевша підписка",
    "vs_last_month" => "порівняно з минулим місяцем",
    "heaviest_month" => "Найдорожчий наступний місяць",
    "months_over_budget" => "Місяці понад бюджет (наступні 12)",
    "manual_renewals" => "Ручні поновлення",
    "all_time_spend" => "Витрати за весь час (оцінка)",
    "oldest_subscription" => "Найстаріша підписка (років)",
    "average_subscription_age" => "Середній вік підписок (років)",
    "projected_cost" => "Прогнозовані витрати (наступні 12 місяців)",
    "lifetime_spend" => "Сумарні витрати (Топ-10, оцінка)",
    "billing_cycle_split" => "Розподіл за циклом оплати",
    "currency_split" => "Розподіл за валютою",
    "price_distribution" => "Розподіл цін",
    "subscriptions_count" => "Підписки",
    "new_subscriptions_per_year" => "Нові підписки за рік",
    "estimated_from_current_prices" => "Оцінка за поточними цінами",
    "translate_categories" => "Перекласти за допомогою ШІ",
    "week_starts_on_sunday" => "Починати тиждень з неділі в календарі",
    "list_view" => "Список",
    "grid_view" => "Сітка",
    "cant_delete_payment_method_in_use" => "Неможливо вимкнути спосіб оплати, що використовується",
    "oidc_oauth_enabled" => "Увімкнути OIDC/OAuth",
