...
$i18n = [
    ...
    "registrations_disable_login_info" => "ユーザー登録を有効にすると、ログインを無効にする設定は利用できなくなります。",
    ...
    "require_email_verified_linking" => "アカウント連携には確認済みメールアドレスが必要",
    "oidc_email_not_verified" => "ログインに失敗しました：メールアドレスがIDプロバイダーによって確認されていません。",
    ...
    "auth_tagline" => "お金の行き先を把握しましょう。",
    "auth_tagline_sub" => "サブスクリプションを管理し、支出を確認し、更新を見逃さないようにしましょう。",
    "overview" => "概要",
    "trends_and_forecast" => "傾向と予測",
    "history_and_lifetime" => "履歴と累計",
    "cost_per_day" => "1日あたりのコスト",
    "median_monthly_cost" => "月額サブスクリプション費用の中央値",
    "cheapest_subscription" => "最も安いサブスクリプション",
    "vs_last_month" => "前月比",
    "heaviest_month" => "今後最も高額な月",
    "months_over_budget" => "予算超過の月（今後12か月）",
    "manual_renewals" => "手動更新",
    "all_time_spend" => "累計支出（推定）",
    "oldest_subscription" => "最も古いサブスクリプション（年）",
    "average_subscription_age" => "サブスクリプションの平均利用年数（年）",
    "projected_cost" => "予測コスト（今後12か月）",
    "lifetime_spend" => "累計支出（上位10件、推定）",
    "billing_cycle_split" => "請求サイクル別の内訳",
    "currency_split" => "通貨別の内訳",
    "price_distribution" => "価格分布",
    "subscriptions_count" => "サブスクリプション数",
    "new_subscriptions_per_year" => "年間の新規サブスクリプション",
    "estimated_from_current_prices" => "現在の価格に基づく推定",
    "translate_categories" => "AIで翻訳",
    "week_starts_on_sunday" => "カレンダーの週を日曜日から開始",
    "list_view" => "リスト表示",
    "grid_view" => "グリッド表示",
    "oidc_oauth_enabled" => "OIDC/OAuthを有効にする",
