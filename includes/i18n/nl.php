...
$i18n = [
    ...
    "Yearly" => "Jaarlijks",
    "One-time" => "Eenmalig",
    "lifetime_purchases" => "Levenslange aankopen",
    "daily" => "Dagen",
    "weekly" => "Weken",
    "monthly" => "Maanden",
    "yearly" => "Jaren",
    ...
    "require_email_verified_linking" => "Geverifieerd e-mailadres vereisen voor accountkoppeling",
    "oidc_email_not_verified" => "Aanmelding mislukt: uw e-mailadres is niet geverifieerd door de identiteitsprovider.",
    ...
    "auth_tagline" => "Weet waar je geld naartoe gaat.",
    "auth_tagline_sub" => "Volg je abonnementen, bekijk je uitgaven en mis nooit een verlenging.",
    "overview" => "Overzicht",
    "trends_and_forecast" => "Trends & prognose",
    "history_and_lifetime" => "Geschiedenis & totaal",
    "cost_per_day" => "Kosten per dag",
    "median_monthly_cost" => "Mediane maandelijkse abonnementskosten",
    "cheapest_subscription" => "Goedkoopste abonnement",
    "vs_last_month" => "t.o.v. vorige maand",
    "heaviest_month" => "Duurste komende maand",
    "months_over_budget" => "Maanden boven budget (komende 12)",
    "manual_renewals" => "Handmatige verlengingen",
    "all_time_spend" => "Totale uitgaven (gesch.)",
    "oldest_subscription" => "Oudste abonnement (jaren)",
    "average_subscription_age" => "Gemiddelde abonnementsleeftijd (jaren)",
    "projected_cost" => "Verwachte kosten (komende 12 maanden)",
    "lifetime_spend" => "Totale uitgaven (top 10, gesch.)",
    "billing_cycle_split" => "Verdeling per factureringscyclus",
    "currency_split" => "Verdeling per valuta",
    "price_distribution" => "Prijsverdeling",
    "subscriptions_count" => "Abonnementen",
    "new_subscriptions_per_year" => "Nieuwe abonnementen per jaar",
    "estimated_from_current_prices" => "Geschat op basis van huidige prijzen",
    "translate_categories" => "Vertalen met AI",
    "week_starts_on_sunday" => "Week op zondag laten beginnen in de kalender",
