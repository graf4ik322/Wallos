...
$i18n = [
    ...
    "Monthly" => "Месяц",
    "Yearly" => "Год",
    "One-time" => "Единовременный",
    "lifetime_purchases" => "Бессрочные покупки",
    "daily" => "День",
    "weekly" => "Неделя",
    "monthly" => "Месяц",
    "yearly" => "Год",
    ...
    "remove_background_info" => "Это также создаёт вторую, перекрашенную версию логотипа, чтобы он оставался читаемым при переключении между светлой и тёмной темой.",
    ...
    "registrations_disable_login_info" => "Если включить регистрацию пользователей, настройка отключения входа станет недоступной.",
    ...
    "require_email_verified_linking" => "Требовать подтверждённый e-mail для связывания аккаунта",
    "oidc_email_not_verified" => "Ошибка входа: адрес электронной почты не подтверждён поставщиком удостоверений.",
    ...
    "auth_tagline" => "Знайте, куда уходят ваши деньги.",
    "auth_tagline_sub" => "Отслеживайте подписки, следите за расходами и не пропускайте продления.",
    "overview" => "Обзор",
    "trends_and_forecast" => "Тренды и прогноз",
    "history_and_lifetime" => "История и итоги",
    "cost_per_day" => "Стоимость в день",
    "median_monthly_cost" => "Медианная месячная стоимость подписки",
    "cheapest_subscription" => "Самая дешёвая подписка",
    "vs_last_month" => "к прошлому месяцу",
    "heaviest_month" => "Самый дорогой предстоящий месяц",
    "months_over_budget" => "Месяцы сверх бюджета (следующие 12)",
    "manual_renewals" => "Ручные продления",
    "all_time_spend" => "Расходы за всё время (оценка)",
    "oldest_subscription" => "Самая старая подписка (лет)",
    "average_subscription_age" => "Средний возраст подписок (лет)",
    "projected_cost" => "Прогнозируемые расходы (следующие 12 месяцев)",
    "lifetime_spend" => "Суммарные расходы (Топ-10, оценка)",
    "billing_cycle_split" => "Распределение по циклам оплаты",
    "currency_split" => "Распределение по валютам",
    "price_distribution" => "Распределение цен",
    "subscriptions_count" => "Подписки",
    "new_subscriptions_per_year" => "Новые подписки за год",
    "estimated_from_current_prices" => "Оценка по текущим ценам",
    "translate_categories" => "Перевести с помощью ИИ",
    "week_starts_on_sunday" => "Начинать неделю с воскресенья в календаре",
    "list_view" => "Список",
    "grid_view" => "Сетка",
    "oidc_oauth_enabled" => "Включить OIDC/OAuth",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "Ещё нет аккаунта?",
    "already_have_account" => "Уже есть аккаунт?",
    "google_search_info" => "Добавляет результаты поиска изображений Google (через SerpAPI) как дополнительный источник при поиске логотипов. Создайте бесплатную учётную запись SerpAPI и вставьте сюда свой ключ API.",
    "monthly_searches_used" => "Использовано поисков в этом месяце",
    ...
    "shift_from_today" => "Отсчёт с даты фактической оплаты",
    ...
    "shift_from_today_short" => "Включено",
];
