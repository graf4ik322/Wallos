...
$i18n = [
    ...
    "restore_database_info" => "Um token de configuração é necessário para restaurar um backup. Obtenha-o usando um dos métodos abaixo:",
    "setup_token_docker" => "Docker: execute docker logs &lt;container-name&gt; e procure por \"Setup token for database restore\"",
    "setup_token_file" => "Bare metal: leia o arquivo db/setup_token.db no servidor",
    ...
    "Yearly" => "Anual",
    "One-time" => "Único",
    "lifetime_purchases" => "Compras vitalícias",
    "daily" => "Dia(s)",
    "weekly" => "Semana(s)",
    "monthly" => "Mês(es)",
    "yearly" => "Ano(s)",
    ...
    "remove_background_info" => "Isso também gera uma segunda versão do logotipo, com as cores ajustadas, para que ele continue legível ao alternar entre o tema claro e o escuro.",
    ...
    "require_email_verified_linking" => "Exigir e-mail verificado para vinculação de conta",
    "oidc_email_not_verified" => "Falha no login: seu endereço de e-mail não foi verificado pelo provedor de identidade.",
    ...
    "auth_tagline" => "Saiba para onde vai o seu dinheiro.",
    "auth_tagline_sub" => "Acompanhe suas assinaturas, veja seus gastos e nunca perca uma renovação.",
    "overview" => "Visão geral",
    "trends_and_forecast" => "Tendências e previsão",
    "history_and_lifetime" => "Histórico e total",
    "cost_per_day" => "Custo por dia",
    "median_monthly_cost" => "Mediana do custo mensal das assinaturas",
    "cheapest_subscription" => "Assinatura mais barata",
    "vs_last_month" => "vs mês anterior",
    "heaviest_month" => "Próximo mês mais caro",
    "months_over_budget" => "Meses acima do orçamento (próximos 12)",
    "manual_renewals" => "Renovações manuais",
    "all_time_spend" => "Gasto total (est.)",
    "oldest_subscription" => "Assinatura mais antiga (anos)",
    "average_subscription_age" => "Idade média das assinaturas (anos)",
    "projected_cost" => "Custo projetado (próximos 12 meses)",
    "lifetime_spend" => "Gasto acumulado (Top 10, est.)",
    "billing_cycle_split" => "Distribuição por ciclo de cobrança",
    "currency_split" => "Distribuição por moeda",
    "price_distribution" => "Distribuição de preços",
    "subscriptions_count" => "Assinaturas",
    "new_subscriptions_per_year" => "Novas assinaturas por ano",
    "estimated_from_current_prices" => "Estimado com base nos preços atuais",
    "translate_categories" => "Traduzir com IA",
    "week_starts_on_sunday" => "Começar a semana no domingo no calendário",
    "list_view" => "Visualização em lista",
    "grid_view" => "Visualização em grade",
    "cronjobs" => "Cronjobs",
    "oidc_oauth_enabled" => "Ativar OIDC/OAuth",
    "other_emails_placeholder" => "user@domain.com;test@user.com",
    "no_account_yet" => "Ainda não tem uma conta?",
    "already_have_account" => "Já tem uma conta?",
    "google_search_info" => "Adiciona resultados de imagens do Google (via SerpAPI) como fonte adicional na busca de logos. Crie uma conta gratuita na SerpAPI e cole aqui a sua chave de API.",
    "monthly_searches_used" => "Pesquisas usadas neste mês",
    "monthly_requests_used" => "Requisições de API usadas neste mês",
