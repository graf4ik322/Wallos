...
$i18n = [
    ...
    "registrations_disable_login_info" => "사용자 등록을 활성화하면 로그인 비활성화 설정을 사용할 수 없습니다.",
    ...
    "require_email_verified_linking" => "계정 연결에 인증된 이메일 필요",
    "oidc_email_not_verified" => "로그인 실패: 이메일 주소가 신원 제공자에 의해 확인되지 않았습니다.",
    ...
    "auth_tagline" => "돈이 어디로 가는지 파악하세요.",
    "auth_tagline_sub" => "구독을 관리하고 지출을 확인하며 갱신을 놓치지 마세요.",
    "overview" => "개요",
    "trends_and_forecast" => "추세 및 예측",
    "history_and_lifetime" => "기록 및 누적",
    "cost_per_day" => "일일 비용",
    "median_monthly_cost" => "월 구독 비용 중앙값",
    "cheapest_subscription" => "가장 저렴한 구독",
    "vs_last_month" => "지난달 대비",
    "heaviest_month" => "가장 비싼 다가오는 달",
    "months_over_budget" => "예산 초과 월 (향후 12개월)",
    "manual_renewals" => "수동 갱신",
    "all_time_spend" => "전체 지출 (추정)",
    "oldest_subscription" => "가장 오래된 구독 (년)",
    "average_subscription_age" => "평균 구독 기간 (년)",
    "projected_cost" => "예상 비용 (향후 12개월)",
    ...
    "estimated_from_current_prices" => "현재 가격 기준 추정",
    "translate_categories" => "AI로 번역",
    "week_starts_on_sunday" => "캘린더에서 일요일부터 주 시작",
    "list_view" => "목록 보기",
    "grid_view" => "그리드 보기",
    "oidc_oauth_enabled" => "OIDC/OAuth 사용",
