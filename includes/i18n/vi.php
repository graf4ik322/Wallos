...
$i18n = [
    ...
    "Yearly" => "Hàng năm",
    "One-time" => "Một lần",
    "lifetime_purchases" => "Mua trọn đời",
    "daily" => "Ngày",
    "weekly" => "Tuần",
    "monthly" => "Tháng",
    "yearly" => "Năm",
    ...
    "require_email_verified_linking" => "Yêu cầu email đã xác minh để liên kết tài khoản",
    "oidc_email_not_verified" => "Đăng nhập thất bại: địa chỉ email của bạn chưa được nhà cung cấp danh tính xác minh.",
    ...
    "auth_tagline" => "Biết tiền của bạn đi đâu.",
    "auth_tagline_sub" => "Theo dõi các gói đăng ký, xem chi tiêu và không bao giờ bỏ lỡ lần gia hạn nào.",
    "overview" => "Tổng quan",
    "trends_and_forecast" => "Xu hướng & Dự báo",
    "history_and_lifetime" => "Lịch sử & Tổng cộng",
    "cost_per_day" => "Chi phí mỗi ngày",
    "median_monthly_cost" => "Chi phí đăng ký hằng tháng trung vị",
    "cheapest_subscription" => "Gói đăng ký rẻ nhất",
    "vs_last_month" => "so với tháng trước",
    "heaviest_month" => "Tháng sắp tới đắt nhất",
    "months_over_budget" => "Số tháng vượt ngân sách (12 tháng tới)",
    "manual_renewals" => "Gia hạn thủ công",
    "all_time_spend" => "Tổng chi tiêu (ước tính)",
    "oldest_subscription" => "Gói đăng ký lâu nhất (năm)",
    "average_subscription_age" => "Tuổi trung bình của gói đăng ký (năm)",
    "projected_cost" => "Chi phí dự kiến (12 tháng tới)",
    "lifetime_spend" => "Tổng chi tiêu (Top 10, ước tính)",
    "billing_cycle_split" => "Phân bổ theo chu kỳ thanh toán",
    "currency_split" => "Phân bổ theo tiền tệ",
    "price_distribution" => "Phân bố giá",
    "subscriptions_count" => "Gói đăng ký",
    "new_subscriptions_per_year" => "Gói đăng ký mới mỗi năm",
    "estimated_from_current_prices" => "Ước tính theo giá hiện tại",
    "translate_categories" => "Dịch bằng AI",
    "week_starts_on_sunday" => "Bắt đầu tuần vào Chủ nhật trong lịch",
    "list_view" => "Chế độ danh sách",
    "grid_view" => "Chế độ lưới",
    "oidc_oauth_enabled" => "Bật OIDC/OAuth",
